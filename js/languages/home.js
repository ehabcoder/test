    ...
    "use strict";
      ...
      $('.toggle-language').click(function() {
        ...
        if ($('.lang').text() === 'عربى') {
          ...
          $('.about-p').html("بمسمي 2758 برخصة رقم 1970 بدأت انطلاقتنا نحو عالم التخليص الجمركي و النقل عام<br>مؤسسة بندر فياض العنزي للتخليص و النقل و بمزيد من العمل و بناء جدار من الثقة بين شركتنا<br>وعملائنا زادت انطلاقتنا و زاد عدد عملائنا و زاد انشطتنا في كل ارجاء المملكة من الشرق الي<br>الغرب و من الشمال الي الجنوب و ازدادت عدد شحناتنا جوا و بحرا و برامن مطار الرياض الي الدمام بمطاراتها و موانيها و جدة و مطار وميناءو محطات السكك الحديديةو ميناء الرياض الجاف<br>نحن من أفضل الشركات و أكثرها خبرة في مجال التخليص الجمركي و النقل. و تربطنا علاقات<br>عمل وطيدة مع نخبة من الشركات و المؤسسات التجارية و الصناعية في المملكة العربية السعودية<br>التي نضطلع اليها جميعا 2030 و نهدف الي التطور نحن نصل جميعا الي رؤية .<br>")
          ...
          $('.branches-p').html('لدينا العديد من الفروف فى جميع انحاءالمملكة لمساعدتك')
